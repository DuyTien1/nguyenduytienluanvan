        ...
        <div>
            ...
            <tbody>
                <tr data-expanded="true">
                    <td>{{ $key->classroom_code }}</td>
                    <td>{{ $key->classroom_name }}</td>  
                    <td>  
                        <div style="display: flex; align-items: center; justify-content: space-around;">
                            <a href="{{ URL::to('/toeditclassroom/'.$key->classroom_id) }}" class="active styling-edit" ui-toggle-class="">
                            <i class="fa fa-pencil text-success text-active"></i>
                            </a>
                            <a onclick="return confirm('Bạn có chắc chắn muốn xóa phòng học này?')" href="{{ URL::to('/deleteclassroom/'.$key->classroom_id) }}" class="active styling-edit" ui-toggle-class="">
