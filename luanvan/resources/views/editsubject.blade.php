        ...
        <section class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="position-center">
                    <form role="form" action="{{ URL::to('/updatesubject/'.$key->subject_id) }}" method="post">
                        {{ csrf_field() }}
                    <div class="form-group">
                        <label for="addbrand">Mã Môn Học</label>
                        <p type="text" class="form-control" id="updatebrand" name="subjectcode">{{ $key->subject_code }}</p>
                    </div>  
                    <div class="form-group">
                        <label for="ckeditorbr">Tên Môn Học</label>
                        <input type="text" class="form-control" value="{{ $key->subject_name }}" id="updatebrand" name="subjectname" data-validation="length" data-validation-length="min1" data-validation-error-msg="Hãy điền thông tin vào trường này!">
                    </div>
