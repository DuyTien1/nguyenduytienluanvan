        ...
        <section class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="position-center">
                    <form role="form" action="{{ URL::to('/updatestudent/'.$key->student_id) }}" method="post">
                        {{ csrf_field() }}
                    <div class="form-group">
                        <label for="addbrand">RFID</label>
                        <p type="text" class="form-control" id="updatebrand" name="studentcode">{{ $key->rfid }}</p>
                    </div>  
                    <div class="form-group">
                        <label for="ckeditorbr">Tên Sinh Viên</label>
                        <input type="text" class="form-control" value="{{ $key->student_name }}" id="updatebrand" name="studentname" data-validation="length" data-validation-length="min1" data-validation-error-msg="Hãy điền thông tin vào trường này!">
                    </div>
